...
1. Fork the `https://github.com/girardinsamuel/masonite-js-routes` repo.
2. Clone that repo into your computer: `git clone http://github.com/your-username/masonite-js-routes.git`.
...
- When making changes to your packages you will need to uninstall the package and reinstall it with
  `pip uninstall masonite-js-routes && pip install .`
